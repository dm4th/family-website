...
| [28](28-security-headers-baseline.md) | Security headers & CSP baseline | 🚧 built, in review — PR #28 (2026-07-02); CSP report-only, enforce-flip after clean window | all | `next.config.ts` only |
