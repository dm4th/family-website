...
| [13 — Welcome & Help](13-onboarding-welcome-help.md) | 🟡 hold | — | **Decided, queued.** In-app family onboarding — a first-login welcome panel + a plain-language `/help` page, eldest-generation-first. Build **after** a testing pass ([docs/testing-playbook.md](../docs/testing-playbook.md)) so it reflects a smoothed app. Adoption-blocking gaps the testing pass surfaces (notifications, first-run orientation) may jump ahead of it. |
