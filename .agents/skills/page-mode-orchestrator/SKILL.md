...
description: Use when adding or refactoring a page in the Mathieson family website so Codex first classifies the page into family, operations, or advisory mode and then applies the correct layout and component recipe.
---

# Page Mode Orchestrator

This skill exists to stop Codex from making every page look the same.
